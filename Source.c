...
int main()
{
	//-----------------------------------------Daha kýsa ve sadece bir günü hesaplayan bir program---------------------
	...
	//----------------------1 ay içerisinde kaç gün ve kaç saat mesai yaptýðýný da alýp hesaplayan program-----------------
	/*
	...
	printf("0 ile 10 saat arasýnda fazladan mesai yapana saat basi verilecek ");
	scanf_s("%d", &onSaat);
	printf("10 ile 20 saat arasýnda fazladan mesai yapana saat basi verilecek ");
	...
	*/
	//-----------------------------------------------------------------------------------------------------
	/*switch case yöntemi zahmet isteyen ve tüm deðerleri girmenizi gerektiren
	bir yöntem olduðu için ben sadece öðrenme amaçlý yaptým*/
	/*
